...
class android::sdk {
  ...
  # to work.
  if ($::kernel == 'Linux') and ($::architecture == 'x86_64' or $::architecture == 'amd64') and $::lsbdistrelease != '14.04' and $::lsbdistrelease != '15.04' and $::lsbdistrelease != '15.10' and $::lsbdistrelease != '16.04' {
  ...
  if $::lsbdistrelease == '14.04' or $::lsbdistrelease == '15.04' or $::lsbdistrelease == '15.10' or $::lsbdistrelease == '16.04' {
